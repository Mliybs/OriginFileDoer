    ...
    class Program
    {
        ...
        public static void Reader(string filepath)
        {
            ...
            foreach((string, int) fileItem in files)
            {
                ...
                {
                    writer.Write(fileContent.text[haveWritten..(haveWritten + Convert.ToInt32(fileItem.Item2))]);
                }

                Console.WriteLine(fileContent.text[haveWritten..(haveWritten + Convert.ToInt32(fileItem.Item2))]);
